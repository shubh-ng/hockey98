...
if(!isset($_SESSION['userId'])) {
  header("Location: index?redirectUrl=sl-bonus-report");
  exit();
} 

require "./model/BonusIncome.php";
$bi = new BonusIncome();
$report = $bi->getBonusIncomeReports($_SESSION['userId'], 'SLB');
?>
...
<head>
  ...
  <title>Single Leg Bonus Report</title>
